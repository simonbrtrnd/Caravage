...
function start() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        function selectNode(id) {
            return __awaiter(this, void 0, void 0, function* () {
                let nodes = [];
                let node = yield figma.getNodeByIdAsync(id);
                if (node != undefined) {
                    nodes.push(node);
